...
public class Admin extends User {
    ...
    private static final Pattern ADMIN_CODE_PATTERN = Pattern
            .compile("^(?=.{8,128}$)(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[^A-Za-z0-9])\\S+$");
    private AccessLevel accessLevel;
    private String adminCodeHash; // Mã định danh bảo mật riêng

    // Constructor 1: Dùng khi tạo Admin mới trong hệ thống
    public Admin(String username, String passwordHash, String fullName, String email, AccessLevel accessLevel,
    ...
    // Hiển thị thông tin của Admin và quyền hạn của họ (Dùng Polymorphism để hiển
    // thị khác nhau giữa các loại User)
    @Override
