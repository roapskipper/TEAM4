...
-- Art cần: artist, creation_year, medium, dimensions
...
VALUES ('item-001', CURRENT_TIMESTAMP, 'ART', 'seller-001', 'Tranh Đông Hồ', 'Tranh dân gian Đông Hồ nổi tiếng', 50000, 'Nghệ nhân Đông Hồ', 1980, 'OIL_PAINT', '60x80cm');
...
-- Electronics cần: brand, model, condition_grade, warranty_months, fully_functional
...
VALUES ('item-002', CURRENT_TIMESTAMP, 'ELECTRONICS', 'seller-001', 'MacBook Pro M3 Max', 'Macbook đời mới nhất 2024', 50000000, 'Apple', 'MacBook Pro M3 Max', 'MINT', 12, true);
INSERT IGNORE INTO auctions (id, created_at, item_id, seller_id, starting_price, current_price, bid_increment, start_time, end_time, status)
...
-- Vehicle cần: brand, model, manufacturing_year, odo, engine_type, color, has_legal_papers, transmission
...
VALUES ('item-003', CURRENT_TIMESTAMP, 'VEHICLE', 'seller-002', 'Honda SH 150i', 'Xe tay ga hạng sang', 80000000, 'Honda', 'SH 150i ABS', 2023, 5000, 'GASOLINE', 'Đen bóng', true, 'AUTOMATIC');
INSERT IGNORE INTO auctions (id, created_at, item_id, seller_id, starting_price, current_price, bid_increment, start_time, end_time, status)
...
-- Fashion cần: brand, size, material, color, gender, condition_grade, authentic
...
VALUES ('item-004', CURRENT_TIMESTAMP, 'FASHION', 'seller-003', 'Túi Gucci Chính Hãng', 'Túi hiệu Gucci từ Italy', 15000000, 'Gucci', 'OTHER', 'Da bò thật', 'Nâu', 'UNISEX', 'LIKE_NEW', true);
INSERT IGNORE INTO auctions (id, created_at, item_id, seller_id, starting_price, current_price, bid_increment, start_time, end_time, status)
...
-- Collectible cần: year_of_origin, rarity_level, condition_grade, has_certificate, origin
...
VALUES ('item-005', CURRENT_TIMESTAMP, 'COLLECTIBLE', 'seller-001', 'Bộ tem cổ thời Đông Dương', 'Tem hiếm từ thế kỷ 20', 3000000, 1945, 'RARE', 'GOOD', true, 'Việt Nam');
INSERT IGNORE INTO auctions (id, created_at, item_id, seller_id, starting_price, current_price, bid_increment, start_time, end_time, status)
