...
INSERT IGNORE INTO items (id, created_at, category, owner_id, name, starting_price, brand)
VALUES ('item-004', CURRENT_TIMESTAMP, 'FASHION', 'seller-003', 'Túi Gucci Chính Hãng', 15000000, 'Gucci');
INSERT IGNORE INTO auctions (id, created_at, item_id, seller_id, current_price, bid_increment, start_time, end_time, status)
VALUES ('auction-004', CURRENT_TIMESTAMP, 'item-004', 'seller-003', 15000000, 500000, CURRENT_TIMESTAMP, DATE_ADD(NOW(), INTERVAL 2 DAY), 'RUNNING');

-- Combo 5: Sưu tầm / Chờ duyệt
INSERT IGNORE INTO items (id, created_at, category, owner_id, name, starting_price)
VALUES ('item-005', CURRENT_TIMESTAMP, 'COLLECTIBLE', 'seller-001', 'Bộ tem cổ thời Đông Dương', 3000000);
INSERT IGNORE INTO auctions (id, created_at, item_id, seller_id, current_price, bid_increment, start_time, end_time, status)
VALUES ('auction-005', CURRENT_TIMESTAMP, 'item-005', 'seller-001', 3000000, 100000, CURRENT_TIMESTAMP, DATE_ADD(NOW(), INTERVAL 10 DAY), 'PENDING');